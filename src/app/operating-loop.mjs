import { detectRisks } from '../risk-detector.mjs?v=2.6.1';
import { reconcileDecisions } from './decision-center.mjs?v=2.6.1';
import {
  METRIC_CATALOG, actualMetrics, buildDailySnapshots, calculateGap, validateTarget,
} from './targets.mjs?v=2.6.1';
import { classifySourceHealth } from './source-health.mjs?v=2.6.1';
import { generateCeoBrief, shouldGenerateBrief } from './daily-brief.mjs?v=2.6.1';
import { humanText } from './value-utils.mjs?v=2.6.1';
