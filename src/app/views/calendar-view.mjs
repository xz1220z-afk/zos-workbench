import { calendarLayout } from '../calendar-center.mjs?v=2.0.0';
import { calendarEventCapabilities } from '../calendar-event.mjs?v=2.0.0';
import { escapeHtml } from './view-utils.mjs?v=2.0.0';
