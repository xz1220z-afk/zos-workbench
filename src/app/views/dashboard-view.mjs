...
import { formatCurrency, humanText } from '../value-utils.mjs?v=2.8.2';
import { partitionDecisions } from '../decision-center.mjs?v=2.8.2';
import { buildWorkHomepagePresence } from '../homepage-presence.mjs?v=2.8.2';
