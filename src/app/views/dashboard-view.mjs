...
import { formatCurrency, humanText } from '../value-utils.mjs?v=2.7.3';
import { partitionDecisions } from '../decision-center.mjs?v=2.7.3';
import { buildWorkHomepagePresence } from '../homepage-presence.mjs?v=2.7.3';
