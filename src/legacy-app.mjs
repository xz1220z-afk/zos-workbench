import { pageIdFromHash } from './app/router.mjs?v=2.12.1';
import { normalizeNavigationMode, shouldExpandNavigation, PRIMARY_NAVIGATION_PAGES } from './app/navigation-preferences.mjs?v=2.12.1';
import { createBusinessDataCache } from './app/business-data-cache.mjs?v=2.12.1';
import { mobilePrimaryPage } from './app/mobile-navigation.mjs?v=2.12.1';
...
(function() {
  ...
  const APP_RELEASE_DATE = '2026-08-17';
