import { pageIdFromHash } from './app/router.mjs?v=2.12.0';
import { normalizeNavigationMode, shouldExpandNavigation, PRIMARY_NAVIGATION_PAGES } from './app/navigation-preferences.mjs?v=2.12.0';
import { createBusinessDataCache } from './app/business-data-cache.mjs?v=2.12.0';
import { mobilePrimaryPage } from './app/mobile-navigation.mjs?v=2.12.0';
