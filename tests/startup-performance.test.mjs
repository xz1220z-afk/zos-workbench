...
test('v1.10 renders the local shell before remote startup and updates without a forced reload', async () => {
  ...
  assert.match(worker, /zos-workbench-v1\.10\.0/);
});
...
test('double-clicking index.html redirects immediately to the official app while https stays in place', async () => {
  ...
  assert.deepEqual(redirected, ['https://xz1220z-afk.github.io/zos-workbench/?v=1.10.0#calendar']);
